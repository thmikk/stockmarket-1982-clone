...
def test_duplicate_news():
    ...
    print(
        f"Initial state: round={game.round}, turn={game.turn}, current_player={game.get_current_player()}"
    )
    ...
    print(
        f"After Player1: round={game.round}, turn={game.turn}, current_player={game.get_current_player()}"
    )
    ...
    print(
        f"After Player2: round={game.round}, turn={game.turn}, current_player={game.get_current_player()}"
    )
